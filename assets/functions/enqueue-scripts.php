...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
	...
	// Adding fancybox file in the footer
    wp_enqueue_script( 'fancybox', get_template_directory_uri() . '/node_modules/fancybox-plus/src/jquery.fancybox-plus.js', array( 'jquery' ), '', true );

    // Register main stylesheet
    wp_enqueue_style( 'site-css', get_template_directory_uri() . '/assets/css/style.min.css', array(), '', 'all' );
	
	// Register fancybox stylesheet
    wp_enqueue_style( 'fancybox-css', get_template_directory_uri() . '/node_modules/fancybox-plus/css/jquery.fancybox-plus.css', array(), '', 'all' );
